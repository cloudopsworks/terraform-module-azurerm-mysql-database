...
| [azurerm_mysql_flexible_database.additional](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/mysql_flexible_database) | resource |
| [azurerm_mysql_flexible_database.initial](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/mysql_flexible_database) | resource |
...
| [azurerm_mysql_flexible_server_configuration.params](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/mysql_flexible_server_configuration) | resource |
...
| <a name="input_network"></a> [network](#input\_network) | Network configuration for Azure MySQL Flexible Server. | `any` | `{}` | no |
...
| <a name="input_settings"></a> [settings](#input\_settings) | Settings for Azure MySQL Flexible Server — see inline docs for full YAML structure. | `any` | `{}` | no |
...
| <a name="output_fqdn"></a> [fqdn](#output\_fqdn) | The FQDN of the MySQL Flexible Server. |
...
| <a name="output_server_id"></a> [server\_id](#output\_server\_id) | The ID of the MySQL Flexible Server. |
| <a name="output_server_name"></a> [server\_name](#output\_server\_name) | The name of the MySQL Flexible Server. |
